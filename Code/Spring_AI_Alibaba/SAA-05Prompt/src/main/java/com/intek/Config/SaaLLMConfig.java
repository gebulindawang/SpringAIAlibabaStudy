...
public class SaaLLMConfig {
    ...
    public ChatClient deepseekClient(@Qualifier(value = "deepseekChatModel")ChatModel chatModel){
    ...
    public ChatClient qwenChatClient(@Qualifier(value = "qwenChatModel") ChatModel chatModel ){
        return ChatClient.builder(chatModel)
                .defaultOptions(ChatOptions.builder()
                        .model(QWEN_MODEL)
                        .build())
